    ...
    <div>
            ...
            {steps.map((step, index) => (
              <div key={index} className="card text-center relative">
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-green-500">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-center gap-4 p-6 bg-zinc-900 border border-zinc-800 rounded-xl">
      ...
      <section className="py-16 px-4">
        <div className="max-w-2xl mx-auto text-center card">
          ...
          <p className="text-zinc-400 mb-6">Start with a free interview. No credit card required.</p>
